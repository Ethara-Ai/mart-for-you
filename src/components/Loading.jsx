 ...
 */
function Loading({ message = 'Loading...', fullScreen = true, size = 'md', className = '' }) {
  ...
  const bgColor = darkMode ? COLORS.dark.backgroundGradient : COLORS.light.backgroundGradient;
