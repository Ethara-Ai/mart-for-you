...
describe('ProductGrid', () => {
  ...
  describe('loading state', () => {
    ...
    it('renders 12 skeleton items when loading', () => {
      const { container } = render(<ProductGrid products={[]} loading={true} />);
    ...
    it('skeleton has content placeholders', () => {
      ...
      const contentArea = container.querySelector('.p-3.space-y-2');
  ...
  describe('onAddToCart handler', () => {
    ...
    it('works without onAddToCart (uses default cart behavior)', async () => {
      ...
      // Should not throw error - component uses default cart context
      expect(document.body).toBeInTheDocument();
    });
  });
  ...
  describe('product rendering', () => {
    ...
    it('renders product weight or truncated description', () => {
      ...
      // ProductCard shows weight or truncated description, not full description
    ...
    it('renders products correctly without category display', () => {
      render(<ProductGrid products={[mockProduct]} />);

      // Category is not displayed in ProductCard, but product renders correctly
      expect(screen.getByText(mockProduct.name)).toBeInTheDocument();
    });
  });
  ...
  describe('skeleton styling', () => {
    ...
    it('skeleton placeholders have correct aspect ratio', () => {
      const { container } = render(<ProductGrid products={[]} loading={true} />);
