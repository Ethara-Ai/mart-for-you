...
function ProfileForm({ onSave, onCancel, compact = false, className = '' }) {
  ...
  const inputBg = darkMode ? COLORS.dark.modalBackground : COLORS.light.background;
    ...
    <form onSubmit={handleSubmit} className={className} noValidate>
      <div className={`space-y-${compact ? '3' : '4'}`}>
        ...
        <div className="grid grid-cols-2 gap-3">
          {/* First Name */}
          <div>
            <label htmlFor="firstName" className={labelClassName} style={{ color: textColor }}>
          ...
          {/* Last Name */}
          <div>
            <label htmlFor="lastName" className={labelClassName} style={{ color: textColor }}>
        ...
        {/* Email */}
        <div>
          <label htmlFor="email" className={labelClassName} style={{ color: textColor }}>
        ...
        {/* Address */}
        <div>
          <label htmlFor="address" className={labelClassName} style={{ color: textColor }}>
            Address
          </label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-2 gap-3">
          {/* City */}
          <div>
            <label htmlFor="city" className={labelClassName} style={{ color: textColor }}>
              City
            </label>
            <input
              type="text"
          ...
          {/* State */}
          <div>
            <label htmlFor="state" className={labelClassName} style={{ color: textColor }}>
              State
            </label>
            <input
              type="text"
        ...
        <div className="grid grid-cols-2 gap-3">
          {/* ZIP */}
          <div>
            <label htmlFor="zip" className={labelClassName} style={{ color: textColor }}>
              ZIP Code
            </label>
            <input
              type="text"
          ...
          {/* Country */}
          <div>
            <label htmlFor="country" className={labelClassName} style={{ color: textColor }}>
              Country
            </label>
            <input
              type="text"
        ...
        {/* Phone */}
        <div>
          <label htmlFor="phone" className={labelClassName} style={{ color: textColor }}>
            Phone
          </label>
          <input
            type="tel"
