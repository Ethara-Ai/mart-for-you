...
describe('Hero', () => {
  ...
  describe('rendering', () => {
    ...
    it('renders default title', () => {
      ...
      expect(screen.getByText('Discover. Shop. Enjoy.')).toBeInTheDocument();
    });
  ...
  describe('CTA button', () => {
    ...
    it('has vertical padding', () => {
      ...
      const ctaButton = screen.getByRole('button', { name: 'Shop Now' });
      expect(ctaButton).toHaveClass('py-2.5');
    });
  ...
  describe('hero section structure', () => {
    ...
    it('has specific height', () => {
      ...
      const heroContainer = container.querySelector('.h-\\[40vh\\]');
    ...
    it('has overflow hidden', () => {
      ...
      const heroContainer = container.querySelector('.overflow-hidden');
      expect(heroContainer).toBeInTheDocument();
    });
  });
  ...
  describe('subtitle styling', () => {
    it('subtitle has responsive font sizes', () => {
      ...
      const subtitle = screen.getByText('Shopping made simple.');
  ...
  describe('responsive design', () => {
    ...
    it('has sm responsive padding', () => {
      ...
      const smPaddedContainer = container.querySelector('.sm\\:px-4');
      expect(smPaddedContainer).toBeInTheDocument();
    });

    it('has content area with responsive padding', () => {
      const { container } = render(<Hero />);

      const contentPaddedContainer = container.querySelector('.px-4');
      expect(contentPaddedContainer).toBeInTheDocument();
    });
  });
  ...
  describe('theme integration', () => {
    ...
    it('hero overlay has background style', () => {
      const { container } = render(<Hero />);
